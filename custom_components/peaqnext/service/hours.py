...
def get_hours_sorted(
    ...
    try:
        ...
        ret = [] 
        for s in sequences:
            _dt_start, _dt_end = _set_dt_start_end(_start, duration_in_seconds, update_per_minute, s)
...
def _set_dt_start_end(_start: datetime, duration_in_seconds: int, update_per_minute: bool, s: int) -> tuple[datetime, datetime]:
